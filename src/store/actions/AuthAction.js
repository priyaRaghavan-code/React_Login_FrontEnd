...
import { SignUp,formatError, login, loginFormatError, saveTokenInLocalStorage } from "../services/AuthService";
...
export function SignUpAction(name,username,email,password,password_confirmation,history){
  return (dispatch) => {
